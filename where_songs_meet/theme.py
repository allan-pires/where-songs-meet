...
CTRL_BTN_HEIGHT = 32
CTRL_BTN_RADIUS = 8
ICON_BTN_WIDTH = 6  # width in chars for icon-only buttons; generous for 1080p so emoji isn't cut off
ICON_BTN_PADX = 12  # horizontal padding for icon-only (text/emoji) so icon isn't clipped at 1080p
